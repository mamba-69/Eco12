...
export const metadata: Metadata = {
  ...
  keywords: "E-waste recycling, electronics waste, Eco Expert Recycling, sustainable tech India, e-waste management, best e-waste recycler, top company for ewaste recycling, indian ewaste company, ecoexpertrecycling, eco expert, eco recycling, eco recyling expert, expert company, exper solutions, expert recycling, about eco expert recycling, about eco expert, about ewaste",
  verification: {

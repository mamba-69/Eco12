...
import { FiStar, FiRefreshCw, FiShield, FiUsers } from 'react-icons/fi';
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-accent/5 blur-3xl animate-pulse-slow" style={{ animationDelay: "1.5s" }} />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10" ref={containerRef}>
        ...
        >
          <span className="text-primary text-sm uppercase tracking-wider font-semibold">Our Purpose</span>
          <h2 className="text-4xl md:text-5xl font-bold mt-2 mb-6">
            Our <span className="text-primary">Mission</span> & Vision
          </h2>
          <p className="text-lg text-muted-foreground">
            We're on a mission to revolutionize e-waste management, creating a circular economy where every 
            electronic device finds new purpose, protecting our planet for future generations.
          </p>
        </motion.div>
              ...
              <div className="relative w-full max-w-[450px] h-[450px] mx-auto">
                <div className="w-full h-full pointer-events-none">
                  ...
                  <div className="absolute top-5 right-5 p-3 rounded-lg bg-background/90 animate-pulse-slow pointer-events-none">
                    <p className="text-sm font-semibold text-muted-foreground">Devices Recycled</p>
                  ...
                  <div className="absolute bottom-5 left-5 p-3 rounded-lg bg-background/90 animate-pulse-slow pointer-events-none">
                    <p className="text-sm font-semibold text-muted-foreground">Recovery Rate</p>
              ...
              >
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">{point.title}</h3>
...
const missionPoints = [
  {
    ...
    description: "Our advanced recycling processes recover up to 95% of materials from e-waste, minimizing landfill impact and conserving natural resources."
  },
  {
    icon: <FiShield className="w-6 h-6 text-primary" />,
    title: "Data Security",
    description: "We ensure complete data destruction on all recycled devices, protecting sensitive information with certified security protocols."
  },
  {
    icon: <FiUsers className="w-6 h-6 text-primary" />,
    title: "Community Impact",
    description: "Through education and local partnerships, we raise awareness about responsible e-waste management and create green job opportunities."
  },
  {
    icon: <FiStar className="w-6 h-6 text-primary" />,
    title: "Circular Economy",
    description: "We transform e-waste into valuable resources that can be reintegrated into manufacturing, completing the circular economy loop."
  }
];

...
function StaticImage({ src, alt, width, height, className, fallbackSrc }) {
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 h-screen items-center pt-20 lg:pt-0">
        ...
        >
          ...
          >
            We transform electronic waste into valuable resources through innovative recycling solutions. 
            Join us in our mission to create a sustainable, circular economy for electronics.
          </motion.p>
        ...
        {mounted && (
          ...
          >
            ...
            <div className="absolute w-[400px] h-[400px] rounded-full bg-primary/10 animate-pulse-slow" style={{ animationDelay: "1s" }} />
            ...
            >
              ...
              <div className="absolute top-0 right-0 p-3 rounded-lg bg-background/80 animate-pulse-slow pointer-events-none">
                <p className="text-xs font-semibold text-muted-foreground">E-Waste Recycled</p>
              ...
              <div className="absolute bottom-0 left-0 p-3 rounded-lg bg-background/80 animate-pulse-slow pointer-events-none">
                <p className="text-xs font-semibold text-muted-foreground">CO₂ Reduced</p>
              ...
              {[1, 2, 3].map((i) => {
                ...
                return (
                  <motion.div
                    ...
                    animate={{
                      rotate: [0, 360],
                      translateX: [`calc(-50% + ${radius}px)`, `calc(-50% - ${radius}px)`, `calc(-50% + ${radius}px)`],
                      translateY: [`calc(-50% + ${i * 20}px)`, `calc(-50% - ${i * 20}px)`, `calc(-50% + ${i * 20}px)`],
                    }}
                    transition={{
                      duration: 15 + i * 5,
                      ease: "linear",

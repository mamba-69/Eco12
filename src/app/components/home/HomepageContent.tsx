  ...
  return (
    <div className="space-y-8 py-8">
      ...
      {content.mission && (
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-center">{content.mission.heading}</h2>
      ...
      {content.achievements && (
        <motion.section 
          ...
          className="py-8"
        >
          <h2 className="text-2xl font-bold mb-8 text-center">{content.achievements.heading}</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {content.achievements.stats.map((stat, index) => (
              <div key={index} className="bg-white dark:bg-gray-700 p-6 rounded-lg text-center shadow-md">
                <p className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">{stat.value}</p>
      ...
      {content.videos && content.videos.videos.length > 0 && (
        <motion.section 
          ...
          className="py-8"
        >
          <h2 className="text-2xl font-bold mb-8 text-center">{content.videos.heading}</h2>

...
import { FiChevronLeft, FiChevronRight, FiPlay, FiPause, FiVolume2, FiVolumeX, FiMaximize } from 'react-icons/fi';
...
export default function MediaSlider() {
  ...
  useEffect(() => {
    const preloadImages = async () => {
      ...
      if (activeIndex < mediaItems.length - 1) imagesToPreload.push(activeIndex + 1);
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Explore our visual content showcasing our facilities, processes, and environmental impact through images and videos.
          </p>
        </motion.div>
                ...
                {mediaItems[activeIndex].type === 'image' ? (
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/80 to-transparent p-6">
                      <h3 className="text-xl font-bold">{mediaItems[activeIndex].title}</h3>
                      <p className="text-sm text-muted-foreground mt-2">{mediaItems[activeIndex].description}</p>
                    </div>
                  </div>
                ) : (
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/90 to-transparent p-6 z-10">
                      <h3 className="text-xl font-bold text-white">{mediaItems[activeIndex].title}</h3>
                      <p className="text-sm text-white/80 mt-2">{mediaItems[activeIndex].description}</p>
                    </div>
...
const mediaItems = [
  {
    ...
    description: 'State-of-the-art e-waste processing center with advanced sorting technology.',
    src: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&w=1200&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&w=320&h=180&q=80'
  },
  {
    type: 'video',
    title: 'Recycling Process Explained',
    description: 'A detailed walkthrough of how we process and recycle electronic waste.',
    src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    thumbnail: 'https://images.unsplash.com/photo-1605600659873-d808a13e4e4c?auto=format&fit=crop&w=320&h=180&q=80'
  },
  {
    type: 'image',
    title: 'Community Collection Drive',
    description: 'Local residents bringing their e-waste to our collection event.',
    src: 'https://images.unsplash.com/photo-1563089145-599997674d42?auto=format&fit=crop&w=1200&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1563089145-599997674d42?auto=format&fit=crop&w=320&h=180&q=80'
  },
  {
    type: 'video',
    title: 'Environmental Impact',
    description: 'How proper e-waste recycling helps reduce pollution and conserve resources.',
    src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
    thumbnail: 'https://images.unsplash.com/photo-1498925008800-019c6d2a3910?auto=format&fit=crop&w=320&h=180&q=80'
  },
  {
    type: 'image',
    title: 'Recovered Materials',
    description: 'Precious metals and other materials recovered from recycled electronics.',
    src: 'https://images.unsplash.com/photo-1605792657660-596af9009e82?auto=format&fit=crop&w=1200&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1605792657660-596af9009e82?auto=format&fit=crop&w=320&h=180&q=80'
  },
  {
    type: 'video',
    title: 'Corporate Sustainability Program',
    description: 'How businesses partner with us to implement sustainable e-waste management.',
    src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    thumbnail: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=320&h=180&q=80'
  }
]; 